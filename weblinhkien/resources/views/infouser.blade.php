...
@section('content')
    ...
    <div class="container-fluid jumbotron">
        <div class="row">
            <div class="col-sm-2">
                <div class="row">
                    <button type="button" class="btn btn-danger"> <i class="fas fa-user"></i> Thông tin tài
                        khoản</button>
                </div>
                <div class="row mt-3">
                    <button type="button" class="btn btn-danger"> <i class="fas fa-info-circle"></i> Chi tiết đặt
                        hàng</button>
                </div>
            </div>
