        ...
        <div class="row ">
            <div class="col-sm-4">
                <div class="pic p-0 img_sp">
                    <img src="../upload/{{ $product->productImage }}" alt="" style="" class="xzoom"
                        xoriginal="../upload/{{ $product->productImage }}">
                </div>
                <div class="img_sp_chitiet xzoom-thums">
                    <a href="../upload/{{ $product->productImage }}" class="card">
                        <img src="../upload/{{ $product->productImage }}"
                            xpreview="../upload/{{ $product->productImage }}" class="xzoom-gallery">
                    </a>
            ...
            <div class="col-sm-8">
                ...
                <div class="d-flex pt-2" style="margin-left: 100px;">
                    ...
                    <input type="number" style="width: 15%;" name="soluong" min="1" max="9" value="1" class="form-control"
                        required>
                </div>
