                        ...
                        <div id="change-item-cart">
                            @if (Session::has('Cart') != null)
                                    ...
                                    <table>
                                        <tbody>
                                            @foreach (Session::get('Cart')->products as $item)
                                                <tr>
                                                    <td class="si-pic"><img
                                                            src="upload/{{ $item['productInfo']->productImage }}"
                                ...
                                <div class="select-button">
                                    <a href="{{ url('List-Carts') }}" class="primary-btn view-card"> <b>XEM GIỎ
                                            HÀNG</b> </a>
...
<div class="container-fluid fixed-top " style="margin-top: 58px; z-index: -1; position: absolute;">
    <nav class="navbar hr">
        <a class="nav-link btn btn-primary " href="{{ route('home') }}"> <i class="fas fa-home"></i> Trang
            chủ</a>
        <a class="nav-link" href="{{ route('gioithieu') }}"><i class="far fa-hand-point-right"></i> Giới
            thiệu</a>
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-content">
                @foreach (App\Category::all() as $item)
                    <a class="dropdown-item"
                        href="{{ route('proshow.show', $item->categoryID) }}">{{ $item->categoryName }}</a>
                @endforeach
            </div>
        </li>
        <a class="nav-link" href="{{ route('proshow.show', 2) }}">CPU</a>
        <a class="nav-link" href="{{ route('proshow.show',7) }}"> Vỏ Case</a>
        <a class="nav-link" href="{{ route('proshow.show',9) }}">Màn hình</a>
        <li class="nav-item dropdown">
