...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('frontend/fontawesome-free-5.13.1-web/fontawesome-free-5.13.1-web/css/all.css') }}">
    ...
    <script src="{{ asset('frontend/fontawesome-free-5.13.1-web/fontawesome-free-5.13.1-web/js/all.js') }}">
    </script>
    <!-- JavaScript -->
