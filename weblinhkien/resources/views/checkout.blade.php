                            ...
                            @if (Session::has('Cart') != null)
                                @foreach (Session::get('Cart')->products as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="font-italic">
                                                {{ number_format($item['productInfo']->listPrice) }}₫</p>
                                        </td>
                                        <td>
                                            <p><b>{{ $item['quanty'] }}</b></p>
                                        </td>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="radio1">
                                                                <input type="radio" class="form-check-input" id="radio1"
                                                                    name="thanhtoan" value="tienmat" checked><b>Thanh toán
                                                                    tại nhà</b>
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="radio2">
                                                                <input type="radio" class="form-check-input" id="radio2"
                                                                    name="thanhtoan" value="tructuyen"><b>Thanh toán trực
                                                                    tuyến</b>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="submit" class="btn btn-info btn-xl mt-3"
                                                                value="Gửi đơn hàng">
                                                        </div>
                                                    </td>
                                                    <td>
                                                    </td>
