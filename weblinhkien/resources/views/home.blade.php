...
@section('content')
    ...
    <div class="container bg-white jumbotron">
        <div class="row mt-3 ">
            <h4 class="list-product-title col-sm-12 bg-danger text-white"> <i class="fas fa-bolt"></i> KHUYẾN MÃI
                ONLINE</h4>
                    ...
                    @foreach ($products as $product)
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="card card-product">
                                <img class="card-img-top" src="./upload/{{ $product->productImage }}"
                                    alt="Card image cap">
                                <div class="card-body">
    ...
    <div class="container">
        <div class=" mt-5 text-info">
            ...
            <h3 style="display: inline;">VỎ CASE</h3>
        </div>
        <div class="container bg-white jumbotron">
                ...
                <div class="product-group">
                    <div class="row ">
                        ...
                        @foreach ($vocase as $item)
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="card card-product">
                                    <img class="card-img-top" src="./upload/{{ $item->productImage }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h6 class="card-title product-title mb-3">
                                            <a data-toggle="tooltip" data-placement="bottom" title="
                            {{ $item->productName }}">
                                        ...
                                        <div class="card-text">
                                            ...
                                            <span class="old-price text-secondary">
                                                {{ number_format($item->listPrice) }}đ
                                            </span>
                                            <br>
                                            <a class="btn btn-success btn-add-to-cart mt-2"
                                                onclick="AddCart({{ $item->productID }})" href="javascript:"><i
                                                    class="fas fa-cart-arrow-down"></i></a>
                                            <a class="btn btn-outline-success btn-detail mt-2 font-weight-bold"
                                                href="{{ route('detail.show', $item->productID) }}"> Xem chi tiết</a>
                                            <span class="badge badge-danger text-white">
