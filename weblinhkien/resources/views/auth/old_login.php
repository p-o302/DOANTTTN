...
charset=utf-8" />
    ...
    <link href="{{ asset('frontend/dangky/dangky.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="mainwap">
        <div class="form-box">
            ...
            <form id="login" class="box" method="POST" action="{{ route('login') }}">
                ...
                <br>
                <input id="password" type="password" name="password" class="input-field" placeholder="Nhập mật khẩu" required autocomplete="current-password">
    ...
    <script src="{{ asset('frontend/dangky/dangky.js') }}"></script>
