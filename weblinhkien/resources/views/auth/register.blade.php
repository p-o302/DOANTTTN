            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Vui lòng nhập vào tên hiển thị">
                        ...
                        <input class="input100" id="name" type="text" name="name" placeholder="Nhập vào Tên !"
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Vui lòng nhập vào Email">
                        ...
                        <input class="input100" id="email" type="email" name="email" placeholder="Nhập vào Email !"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Vui lòng nhập mật khẩu">
                        ...
                        <input class="input100" name="password" id="password" type="password"
                            placeholder="Nhập mật khẩu !" required autocomplete="new-password">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Vui lòng nhập lại mật khẩu">
                        ...
                        <input class="input100" type="password" name="password_confirmation" id="password-confirm"
                            placeholder="Nhập lại mật khẩu !" required autocomplete="new-password">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
